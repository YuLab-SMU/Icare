#' K-means with Optimal K (Alternative)
#'
...
#' @export
kmeans_with_optimal_k_alt <- function(data,
...
#' Sub K-means with Optimal K (Alternative)
#'
...
#' @param k.max K max.
#' @export
Sub_kmeans_with_optimal_k_alt <- function(object,
  ...
  # 执行K-means聚类
  kmeans_result <- kmeans_with_optimal_k_alt(
    numeric_data,

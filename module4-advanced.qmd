...
# Features actually required by the fitted PrognosiX model
required_features <- prog@best.model$train_cols
cat("Required prediction features:\n")
print(required_features)
# Use actual training observations as deployment examples
new_patients <- as.data.frame(prog@clean.data[train_idx[1:2], , drop = FALSE])
# Keep exactly the features required by the fitted model
new_patients <- new_patients[, required_features, drop = FALSE]

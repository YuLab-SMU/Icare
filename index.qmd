...
The `icare` package is authored by Huaichao Luo, Fei Long, Hongyan Lin, Chunhui Yuan, Fubing Wang, Jian Huang, and Guangchuang Yu. Huaichao Luo is the package maintainer (`luohc@uestc.edu.cn`). Package development and issue tracking take place in the [YuLab-SMU/icare repository](https://github.com/YuLab-SMU/icare).

# Module 3: Unsupervised Subtyping — Advanced

The advanced `Subtyping` workflow normalizes independent development and validation sets, compares K-means, latent profile analysis (LPA), and NMF, and evaluates t-SNE/UMAP structure, internal cluster quality, cross-method agreement, marker profiles, silhouettes, alluvial relationships, and deployment to new samples.

## Preventing Information Leakage

Split the data first, fit min–max parameters on the development set, and apply them unchanged to validation data. The workflow also checks numeric types and removes zero-variance features. Embeddings are exploratory: choose and validate a subtype solution using stability, agreement, marker reproducibility, and clinical usefulness rather than visual separation alone.
...
tryCatch(
  ...
  error = function(e) message("Sample-level heatmap skipped (raster backend): ", e$message)
)
...
tryCatch(
  ...
  error = function(e) message("Annotated sample-level heatmap skipped (raster backend): ", e$message)
)
...
### SCI Composite: Unsupervised Subtyping and Subtype Profiles

Panels show: A, NMF basis; B, LPA profiles; C, t-SNE subtype distribution; D, NMF rank diagnostics; E, subtype-marker heatmap; F, cross-method subtype flow. Report the basis for subtype number, separation, agreement, and interpretable marker patterns.

<object data="image/composite_figures/module3_composite.pdf" type="application/pdf" width="100%" height="760"><a href="image/composite_figures/module3_composite.pdf">Download Module 3 SCI composite</a></object>

<object data="image/module3/key_figures/nmf_basis.pdf" type="application/pdf" width="100%" height="720"><a href="image/module3/key_figures/nmf_basis.pdf">NMF basis plot</a></object>

<object data="image/module3/key_figures/lpa_profile.pdf" type="application/pdf" width="100%" height="520"><a href="image/module3/key_figures/lpa_profile.pdf">LPA profile plot</a></object>

<object data="image/module3/key_figures/tsne_subtypes.pdf" type="application/pdf" width="100%" height="540"><a href="image/module3/key_figures/tsne_subtypes.pdf">t-SNE subtype plot</a></object>
